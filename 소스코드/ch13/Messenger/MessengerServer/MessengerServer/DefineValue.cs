namespace MessengerServer
{
    ...
    public enum MSG : byte
    {
        ...
        STOC_MESSAGE_FRIEND_ADD_OK = 41,  // 친구 정보 추가 성공
        STOC_MESSAGE_FRIEND_ADD_FAIL = 42,  // 친구 정보 추가 실패

        CTOS_MESSAGE_FRIEND_MODIFY = 43,  // 친구 정보 변경
        STOC_MESSAGE_FRIEND_MODIFY_OK = 44,  // 친구 정보 변경 성공
        STOC_MESSAGE_FRIEND_MODIFY_FAIL = 45,  // 친구 정보 변경 실패

        CTOS_MESSAGE_FRIEND_REMOVE = 46,  // 친구 정보 삭제
        STOC_MESSAGE_FRIEND_REMOVE_OK = 47,  // 친구 정보 삭제 성공
        STOC_MESSAGE_FRIEND_REMOVE_FAIL = 48,  // 친구 정보 삭제 실패
